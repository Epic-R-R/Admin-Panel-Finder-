...
system('clear');
system('Admin Control Panel Finder');
print color('green');
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>     		     Admin Panle Finder              >\n";
print color('bold blue');
print "\t>     		============================         >\n";
print "\t>             [+]    SYNERGY MASK Team    [+]        >\n";
print "\t>     		============================         >\n";
print color('YELLOW');
print "\t>               ------------------------             >\n";
print "\t>              |    Cod3d By Salivan    |            >\n";
print "\t>               ------------------------             >\n";
print color('green');
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
print " Please Enter Target Site URL:(Example: victim.com/www.victim.com) -> ";
$site=<STDIN>;
chomp ($site);
print "\n";
print color('YELLOW');
